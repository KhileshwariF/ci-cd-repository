...
public class Demo1 {
	...
	public static void main(String[] args) {
		...
		driver.get("http://localhost:8080/selenium-demo/");
		System.out.println(driver.getTitle());
		//try { Thread.sleep(2000); } catch(Exception e) { }
		//driver.findElement(By.tagName("a")).click();
		//driver.findElement(By.id("link1")).click();
		driver.findElement(By.className("loginlink")).click();
		//driver.findElement(By.name("username")).sendKeys("khilu");
		//driver.findElement(By.name("password")).sendKeys("123");
		driver.findElement(By.cssSelector("input[placeholder='Username']")).sendKeys("khilu");
